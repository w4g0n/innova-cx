...
('CX-D003', 'Network printer offline – Leasing team',
 ...
 (SELECT id FROM users WHERE email='customer1@innova.cx'),
 (SELECT id FROM users WHERE email='noura@innova.cx'),
...
('CX-O001', 'Carpet tiles lifting – open plan L4',
 ...
 'Civil', (SELECT id FROM departments WHERE name='Facilities Management'),
 (SELECT id FROM users WHERE email='customer1@innova.cx'),
 (SELECT id FROM users WHERE email='dina@innova.cx'),
...
FROM (VALUES
  ('CX-F001','khalid@innova.cx','accepted',
  ...
  ('CX-F005','bilal@innova.cx','accepted',
  ...
  ('CX-J001','khalid@innova.cx','accepted',
   'Replace faulty ballasts and upgrade to LED drivers.',
   NULL, 'All ballasts replaced with LED drivers. Flickering eliminated.'),
  ('CX-J002','fatima@innova.cx','accepted',
  ...
  ('CX-J003','hassan@innova.cx','accepted',
  ...
  ('CX-D003','noura@innova.cx','accepted',
  ...
  ('CX-D004','ziad@innova.cx','accepted',
  ...
  ('CX-O001','dina@innova.cx','declined_custom',
  ...
  ('CX-O002','fatima@innova.cx','accepted',
  ...
  ('CX-S002','khalid@innova.cx','accepted',
  ...
  ('CX-M001','omar@innova.cx','accepted',
  ...
  ('CX-P001','ziad@innova.cx','accepted',
   'Replace thermostat and test water temperature at all outlets.',
...
FROM (VALUES
  ('REQ-5001','CX-F002','Rerouting','Dept: Safety & Security','Dept: HR',
   'Biometric readers serve HR staff — HR team should own the ticket.',
   'hassan@innova.cx','2026-02-05 09:00:00+00','Rejected',
   'manager@innova.cx','2026-02-05 10:00:00+00',
   'Security owns all access control — HR is the user, not the owner.'),
  ('REQ-5002','CX-F005','Rescoring','Priority: Medium','Priority: High',
   ...
   'bilal@innova.cx','2026-02-12 11:30:00+00','Approved',
   'manager@innova.cx','2026-02-12 12:00:00+00',
  ...
  ('REQ-5003','CX-F008','Rerouting','Dept: Safety & Security','Dept: IT',
   ...
   'omar@innova.cx','2026-02-22 07:15:00+00','Rejected',
   'manager@innova.cx','2026-02-22 08:00:00+00',
  ...
  ('REQ-5004','CX-F010','Rescoring','Priority: Critical','Priority: High',
   ...
   'lena@innova.cx','2026-02-26 15:00:00+00','Pending',
   NULL, NULL, NULL),
  ('REQ-5005','CX-J003','Rerouting','Dept: Safety & Security','Dept: Facilities Management',
   ...
   'hassan@innova.cx','2026-01-12 10:30:00+00','Approved',
   'manager@innova.cx','2026-01-12 11:00:00+00',
  ...
  ('REQ-5006','CX-D004','Rescoring','Priority: High','Priority: Critical',
   ...
   'ziad@innova.cx','2025-12-20 09:30:00+00','Approved',
   'manager@innova.cx','2025-12-20 10:00:00+00',
  ...
  ('REQ-5007','CX-N003','Rerouting','Dept: Facilities Management','Dept: Safety & Security',
   ...
   'sara@innova.cx','2025-11-18 10:20:00+00','Approved',
   'manager@innova.cx','2025-11-18 11:00:00+00',
  ...
  ('REQ-5008','CX-O001','Rescoring','Priority: Medium','Priority: Low',
   ...
   'dina@innova.cx','2025-10-05 10:00:00+00','Rejected',
   'manager@innova.cx','2025-10-05 11:00:00+00',
  ...
  ('REQ-5009','CX-S002','Rerouting','Dept: Facilities Management','Dept: Maintenance',
   ...
   'khalid@innova.cx','2025-09-10 09:30:00+00','Pending',
   NULL, NULL, NULL),
  ('REQ-5010','CX-F009','Rescoring','Priority: High','Priority: Critical',
   ...
   'ahmed@innova.cx','2026-02-24 08:20:00+00','Approved',
   'manager@innova.cx','2026-02-24 08:40:00+00',
...
FROM (VALUES
  ('customer1@innova.cx','2026-02-03 07:00:30+00','Lift motor in Tower 1 is overheating — smell of burning!','report_issue','false',0.0350,-0.82,'Elevator',NULL,'CX-F001'),
  ('customer2@innova.cx','2026-02-05 08:30:30+00','Biometric readers on HR floor rejecting all fingerprints.','report_issue','false',0.0200,-0.55,'Access Control',1050,'CX-F002'),
  ('customer3@innova.cx','2026-02-22 07:00:30+00','All intercoms at entry points have no audio!','report_issue','false',0.0400,-0.70,'Communications',NULL,'CX-F008'),
  ('customer1@innova.cx','2026-02-24 08:00:30+00','CO2 levels high in Wing C — AHU filter seems blocked.','report_issue','false',0.0280,-0.45,'HVAC',900,'CX-F009'),
  ('customer2@innova.cx','2026-02-18 14:00:30+00','What is the escalation process for facilities issues?','inquiry','false',0.0050,0.10,'General',640,NULL),
  ('customer3@innova.cx','2026-01-12 10:00:30+00','The roof emergency exit door will not open from inside!','report_issue','false',0.0450,-0.72,'Civil',NULL,'CX-J003'),
  ('customer1@innova.cx','2026-01-06 07:00:30+00','Server backup jobs have been failing since January 3rd.','report_issue','false',0.0220,-0.65,'IT',NULL,'CX-J002'),
  ('customer2@innova.cx','2026-01-20 11:00:30+00','What is the current status of my last submitted ticket?','inquiry','false',0.0050,0.00,'General',610,NULL),
  ('customer3@innova.cx','2025-12-03 07:00:30+00','All cameras at the main gate are showing no signal.','report_issue','false',0.0320,-0.75,'CCTV',NULL,'CX-D001'),
  ('customer1@innova.cx','2025-12-18 14:00:30+00','How often are the HVAC filters supposed to be replaced?','inquiry','false',0.0040,0.10,'HVAC',620,NULL),
  ('customer2@innova.cx','2025-11-06 09:00:30+00','Emergency lights failed to come on during the fire drill.','report_issue','false',0.0400,-0.70,'Electrical',NULL,'CX-N001'),
  ('customer3@innova.cx','2025-11-12 08:00:30+00','All desk phones are completely dead — no dial tone.','report_issue','false',0.0380,-0.72,'Telephony',NULL,'CX-N002'),
  ('customer1@innova.cx','2025-11-20 10:00:30+00','Can I book the conference room through the chat?','inquiry','false',0.0040,0.20,'General',580,NULL),
  ('customer2@innova.cx','2025-10-20 10:00:30+00','The stairwell 3 fire door stays wide open — it is a fire hazard.','report_issue','false',0.0380,-0.62,'Fire Safety',NULL,'CX-O003'),
  ('customer3@innova.cx','2025-10-08 15:00:30+00','How do I submit a formal complaint about repeated issues?','inquiry','false',0.0060,0.05,'General',600,NULL)
