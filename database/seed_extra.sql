...
FROM (VALUES
  ...
  ('CX-H013', 'electrical_inspection_report.pdf',
   ...
   'sarah@innovacx.net', '2026-02-05 08:00:00+00'),
  ...
  ('CX-H002', 'electrical_panel_photo.jpg',
   ...
   'sarah@innovacx.net', '2025-04-10 14:00:00+00'),
...
FROM (VALUES
  ...
  ('CX-H002','sarah@innovacx.net','status_change',
  ...
  ('CX-H013','sarah@innovacx.net','status_change',
  ...
  ('CX-A003','sarah@innovacx.net','internal_note',
  ...
  ('CX-A006','sarah@innovacx.net','internal_note',
...
FROM (VALUES
  ...
  ('CX-H002','sarah@innovacx.net','accepted',
  ...
  ('CX-H013','sarah@innovacx.net','accepted',
...
FROM (VALUES
  ...
  ('REQ-4003','CX-A009','Rescoring','Priority: Medium','Priority: High',
   ...
   'sameer@innovacx.net','2026-03-01 11:10:00+00','Pending',
   NULL, NULL, NULL),
  ...
  ('REQ-4005','CX-A003','Rerouting','Dept: Maintenance','Dept: Facilities Management',
   ...
   'sarah@innovacx.net','2026-03-01 09:00:00+00','Rejected',
  ...
  ('REQ-4010','CX-A006','Rerouting','Dept: Facilities Management','Dept: Maintenance',
   ...
   'sarah@innovacx.net','2026-03-01 10:00:00+00','Pending',
   NULL, NULL, NULL)
...
WHERE user_id    = (SELECT id FROM users WHERE email = 'customer1@innovacx.net')
...
FROM (VALUES
  ...
  ('hamad@innovacx.net','sla_warning','SLA Warning — CX-A001',
  ...
  ('hamad@innovacx.net','ticket_assignment','Approval Requested — REQ-4004',
  ...
  ('hamad@innovacx.net','status_change','Approval Approved — REQ-4008',
   'You approved the rescoring of CX-H014 from Medium to High. Bilal Khan notified.',
   'High','CX-H014',TRUE,'2026-02-15 11:00:00+00'),
  ('hamad@innovacx.net','ticket_assignment','Approval Requested — REQ-4006',
  ...
  -- Sara notifications
  ('sarah@innovacx.net','ticket_assignment','New Ticket Assigned: CX-A006',
   'You have been assigned CX-A006 — Cleaning missed Block D. Medium priority.',
   'Medium','CX-A006',FALSE,'2026-03-01 09:45:00+00'),
  ('sarah@innovacx.net','customer_reply','Customer replied on CX-H015',
  ...
  ('sameer@innovacx.net','ticket_assignment','New Ticket Assigned: CX-A009',
   'You have been assigned CX-A009 — Roof membrane leak – Executive floor. High priority.',
   'High','CX-A009',FALSE,'2026-03-01 11:20:00+00'),
  ('sameer@innovacx.net','status_change','Approval Decision: REQ-4003',
...
SELECT
  ...
  now() + interval '1 hour',
  NULL
WHERE EXISTS (SELECT 1 FROM users WHERE email = 'customer1@innovacx.net')
  AND NOT EXISTS (
...
SELECT
  ...
  now() - interval '2 hours',
  now() - interval '1 hour'
WHERE EXISTS (SELECT 1 FROM users WHERE email = 'sarah@innovacx.net')
  AND NOT EXISTS (
    SELECT 1 FROM password_reset_tokens
    WHERE user_id = (SELECT id FROM users WHERE email = 'sarah@innovacx.net')
