...
-- 17.  notifications
-- 18.  employee_reports
-- 19.  employee_report_summary_items
-- 20.  employee_report_rating_components
-- 21.  employee_report_weekly
-- 22.  employee_report_notes
...
SELECT t.id,
  ...
  v.conf_score, v.err_flag, v.err_msg,
  v.infra::jsonb
FROM (VALUES
  -- CX-A001 — full pipeline
  ('CX-A001','sentiment','sentiment-v3.1','ingest',
   '2026-03-01 06:01:00+00','2026-03-01 06:01:04+00','success',
   420,29,4200,0.9412,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A001','priority','priority-v2.4','ingest',
   '2026-03-01 06:01:05+00','2026-03-01 06:01:09+00','success',
   428,32,3900,0.9600,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A001','routing','routing-v1.8','ingest',
   '2026-03-01 06:01:10+00','2026-03-01 06:01:14+00','success',
   432,26,4100,0.9700,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A001','sla','sla-v1.2','ingest',
   '2026-03-01 06:01:15+00','2026-03-01 06:01:17+00','success',
   195,19,2200,0.9800,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-c5.large"}'),
  ('CX-A001','resolution','resolution-v2.0','ingest',
   '2026-03-01 06:01:18+00','2026-03-01 06:01:27+00','success',
   620,145,9200,0.9600,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A001','feature','feature-v1.5','ingest',
   '2026-03-01 06:01:28+00','2026-03-01 06:01:31+00','success',
   385,46,3300,0.9500,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-c5.large"}'),

  -- CX-A002 — full pipeline
  ('CX-A002','sentiment','sentiment-v3.1','ingest',
   '2026-03-01 07:31:00+00','2026-03-01 07:31:05+00','success',
   392,27,4500,0.9107,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A002','priority','priority-v2.4','ingest',
   '2026-03-01 07:31:06+00','2026-03-01 07:31:10+00','success',
   400,31,3800,0.9400,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A002','routing','routing-v1.8','ingest',
   '2026-03-01 07:31:11+00','2026-03-01 07:31:15+00','success',
   405,24,4000,0.9500,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A002','resolution','resolution-v2.0','ingest',
   '2026-03-01 07:31:16+00','2026-03-01 07:31:26+00','success',
   595,140,9100,0.9400,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),

  -- CX-A004 — with one failure and retry
  ('CX-A004','resolution','resolution-v2.0','ingest',
   '2026-03-01 08:16:00+00','2026-03-01 08:16:12+00','failed',
   610,0,0,NULL,TRUE,
   'Model timeout after 12 seconds — upstream API latency spike.',
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","retry":false}'),
  ('CX-A004','resolution','resolution-v2.0','reprocess',
   '2026-03-01 08:30:00+00','2026-03-01 08:30:09+00','success',
   610,138,9000,0.9500,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","retry":true}'),
  ('CX-A004','sentiment','sentiment-v3.1','ingest',
   '2026-03-01 08:16:30+00','2026-03-01 08:16:34+00','success',
   398,28,4100,0.8910,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),
  ('CX-A004','priority','priority-v2.4','ingest',
   '2026-03-01 08:16:35+00','2026-03-01 08:16:39+00','success',
   405,31,3700,0.9500,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge","gpu":"A10G"}'),

  -- CX-H001 (historical) — manual reprocess
  ('CX-H001','sentiment','sentiment-v3.1','manual',
   '2025-03-05 06:05:00+00','2025-03-05 06:05:04+00','success',
   410,28,4000,0.9600,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge"}'),
  ('CX-H001','resolution','resolution-v2.0','manual',
   '2025-03-05 06:05:05+00','2025-03-05 06:05:14+00','success',
   605,142,9200,0.9800,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge"}'),

  -- CX-H007 — skipped routing (dept already set)
  ('CX-H007','routing','routing-v1.8','ingest',
   '2025-09-12 08:01:00+00','2025-09-12 08:01:01+00','skipped',
   0,0,0,NULL,FALSE,NULL,
   '{"skip_reason":"department_already_assigned"}'),
  ('CX-H007','sentiment','sentiment-v3.1','ingest',
   '2025-09-12 08:01:02+00','2025-09-12 08:01:06+00','success',
   405,27,4200,0.9250,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge"}'),
  ('CX-H007','priority','priority-v2.4','ingest',
   '2025-09-12 08:01:07+00','2025-09-12 08:01:11+00','success',
   412,30,3900,0.9700,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge"}'),

  -- CX-A010 — running (in-flight)
  ('CX-A010','sentiment','sentiment-v3.1','ingest',
   '2026-03-01 11:31:00+00', NULL, 'running',
   0,0,0,NULL,FALSE,NULL,
   '{"region":"me-south-1","instance":"ml-g4dn.xlarge"}')
...
FROM (VALUES
  ('CX-A001','Negative', -0.7800, 0.9412,
   ...
   '{"negative":0.9412,"neutral":0.0421,"positive":0.0167}'),
  ('CX-A002','Negative', -0.6500, 0.9107,
   ARRAY['angry','urgent','concerned'],
   '{"negative":0.9107,"neutral":0.0621,"positive":0.0272}'),
  ('CX-A004','Negative', -0.6000, 0.8910,
   ARRAY['frustrated','concerned'],
   '{"negative":0.8910,"neutral":0.0780,"positive":0.0310}'),
  ('CX-H001','Negative', -0.8200, 0.9600,
   ARRAY['panicked','urgent','distressed'],
   '{"negative":0.9600,"neutral":0.0300,"positive":0.0100}'),
  ('CX-H007','Negative', -0.7200, 0.9250,
   ARRAY['frustrated','urgent'],
   '{"negative":0.9250,"neutral":0.0500,"positive":0.0250}')
...
ORDER BY mel.started_at
LIMIT 1;

-- Bulk insert for additional sentiment outputs (using subquery approach)
INSERT INTO public.sentiment_outputs (
  execution_id, ticket_id, model_version,
  sentiment_label, sentiment_score, confidence_score,
  emotion_tags, raw_scores, is_current
...
FROM (VALUES
  ('CX-A001','Negative', -0.7800, 0.9412,
   '{frustrated,urgent,distressed}',
   '{"negative":0.9412,"neutral":0.0421,"positive":0.0167}'),
  ('CX-A002','Negative', -0.6500, 0.9107,
   '{angry,urgent,concerned}',
   '{"negative":0.9107,"neutral":0.0621,"positive":0.0272}'),
  ('CX-A004','Negative', -0.6000, 0.8910,
   '{frustrated,concerned}',
   '{"negative":0.8910,"neutral":0.0780,"positive":0.0310}'),
  ('CX-H001','Negative', -0.8200, 0.9600,
   '{panicked,urgent,distressed}',
   '{"negative":0.9600,"neutral":0.0300,"positive":0.0100}'),
  ('CX-H007','Negative', -0.7200, 0.9250,
   '{frustrated,urgent}',
   '{"negative":0.9250,"neutral":0.0500,"positive":0.0250}')
...
SELECT DISTINCT ON (mel.ticket_id)
  mel.id, mel.ticket_id, mel.model_version,
  pv.priority::ticket_priority, pv.conf, pv.reasoning, TRUE
FROM (VALUES
  ('CX-A001','Critical',0.9600,
   'HVAC failure in server room — immediate hardware risk. Historical pattern: Critical.'),
  ('CX-A002','Critical',0.9400,
   'Total access control failure — 32 staff blocked. Safety-critical classification.'),
  ('CX-A004','Critical',0.9500,
   '20 workstations offline — business operations halted. Network switch failure pattern.'),
  ('CX-H001','Critical',0.9800,
   'Gas leak sensor — immediate life safety risk. Auto-classified Critical.'),
  ('CX-H007','Critical',0.9700,
   'Building-wide chiller failure — all occupants affected. Critical HVAC classification.')
) AS pv(tc, priority, conf, reasoning)
JOIN public.model_execution_log mel
  ON mel.ticket_id = (SELECT id FROM public.tickets WHERE ticket_code = pv.tc LIMIT 1)
...
FROM (VALUES
  ...
  ('CX-A002','Safety & Security',0.9500,
   'Access control system failure → Security department primary owner.'),
  ('CX-A004','IT',0.9600,
   'Network infrastructure fault on floor → IT department classification.'),
  ('CX-H001','Facilities Management',0.9800,
   'Gas system is Facilities asset — emergency routing confirmed.'),
  ('CX-H007','Facilities Management',0.9900,
   'Chiller plant is Facilities Management primary asset.')
) AS rv(tc, dept_name, conf, reason)
JOIN public.model_execution_log mel
  ON mel.ticket_id = (SELECT id FROM public.tickets WHERE ticket_code = rv.tc LIMIT 1)
...
INSERT INTO public.sla_outputs (
  ...
  breach_risk, confidence_score, is_current
)
SELECT DISTINCT ON (mel.ticket_id)
  mel.id, mel.ticket_id, mel.model_version,
  sv.respond_mins, sv.resolve_mins,
  sv.breach_risk, sv.conf, TRUE
FROM (VALUES
  ('CX-A001', 28, 355, 0.9800, 0.9800),
  ('CX-A002', 22, 361, 0.9600, 0.9600),
  ('CX-A004', 27, 358, 0.9700, 0.9500),
  ('CX-H001', 24, 354, 0.9900, 0.9900),
  ('CX-H007', 28, 360, 0.9700, 0.9700)
) AS sv(tc, respond_mins, resolve_mins, breach_risk, conf)
JOIN public.model_execution_log mel
  ON mel.ticket_id = (SELECT id FROM public.tickets WHERE ticket_code = sv.tc LIMIT 1)
...
FROM (VALUES
  ('CX-A001', 0.9600,
   ...
   ARRAY['KB-2201','KB-2209']),
  ('CX-A002', 0.9400,
   'Restart the access control server and force a full badge database synchronisation. If issue persists, issue manual access passes and schedule emergency firmware update.',
   ARRAY['KB-3310','KB-3318']),
  ('CX-A004', 0.9500,
   'Replace the failed network switch with a spare unit. Verify all 20 workstations reconnect. Document port configuration and update network topology map.',
   ARRAY['KB-5501','KB-5508']),
  ('CX-H001', 0.9800,
   'Isolate gas supply at main valve immediately. Evacuate area. Replace faulty valve and conduct leak test before authorising re-entry.',
   ARRAY['KB-7701','KB-7705']),
  ('CX-H007', 0.9700,
   'Replace chiller compressor with compatible unit from spares inventory. Recharge refrigerant to specification. Run full building cooling test before sign-off.',
   ARRAY['KB-2301','KB-2315'])
) AS rv(tc, conf, suggestion, kb)
JOIN public.model_execution_log mel
  ON mel.ticket_id = (SELECT id FROM public.tickets WHERE ticket_code = rv.tc LIMIT 1)
...
SELECT DISTINCT ON (mel.ticket_id)
  mel.id, mel.ticket_id, mel.model_version,
  fv.asset_cat, fv.topics, fv.conf, fv.raw::jsonb, TRUE
FROM (VALUES
  ('CX-A001', 'HVAC',
   ARRAY['cooling','mechanical','server-room','temperature','critical'],
   0.9500,
   '{"word_count":32,"avg_sentiment":-0.78,"capital_ratio":0.11,"question_marks":0}'),
  ('CX-A002', 'Access Control',
   ARRAY['badge','gate','authentication','security','blocked'],
   0.9300,
   '{"word_count":26,"avg_sentiment":-0.65,"capital_ratio":0.09,"question_marks":0}'),
  ('CX-A004', 'Network Infrastructure',
   ARRAY['network','switch','floor','workstations','offline'],
   0.9100,
   '{"word_count":22,"avg_sentiment":-0.60,"capital_ratio":0.10,"question_marks":0}'),
  ('CX-H001', 'Gas System',
   ARRAY['gas','leak','kitchen','safety','alarm'],
   0.9700,
   '{"word_count":19,"avg_sentiment":-0.82,"capital_ratio":0.14,"question_marks":0}'),
  ('CX-H007', 'HVAC',
   ARRAY['chiller','cooling','compressor','building-wide','refrigerant'],
   0.9600,
   '{"word_count":28,"avg_sentiment":-0.72,"capital_ratio":0.12,"question_marks":0}')
