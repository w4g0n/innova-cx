 ...
 *
 * Returns base64-encoded MP3 audio from the backend (edge-tts / Microsoft
 * Neural TTS).  Returns null if the backend TTS service is unavailable so
 * the caller can fall back to browser SpeechSynthesis.
 *
